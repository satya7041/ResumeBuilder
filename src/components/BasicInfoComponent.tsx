    ...
    const BasicInfoComponent: React.FC<BasicInfoComponentProps> = ({ onUpdate }) => {
      ...
      <input className='mt-1 px-3 py-2 block w-full rounded-md border border-gray-300 text-gray-900 shadow-sm outline-none font-normal text-base'
          ...
          <div>
          <label  className='text-base font-medium text-gray-700 col-span-full'>Objective:</label>
          ...
          <div>
          <label className='text-base font-medium text-gray-700 col-span-4'>Email:</label>
          <input className=' mt-1 px-3 py-2 block w-full rounded-md border border-gray-300 text-gray-900 shadow-sm outline-none font-normal text-base'
            type="email"
            name="email"
          ...
          <div>
          <label className='text-base font-medium text-gray-700 col-span-2'>Phone Number:</label>
          <input className='mt-1 px-3 py-2 block w-full rounded-md border border-gray-300 text-gray-900 shadow-sm outline-none font-normal text-base'
            type="tel"
            name="phoneNumber"
          ...
          <label  className='class="text-base font-medium text-gray-700 col-span-4"'>Linkedin</label>
          <input className='mt-1 px-3 py-2 block w-full rounded-md border border-gray-300 text-gray-900 shadow-sm outline-none font-normal text-base'
            type="url"
            name="linkedin"
          ...
          <div>
          <label  className='text-base font-medium text-gray-700 col-span-2'>Location</label>
          <input className='mt-1 px-3 py-2 block w-full rounded-md border border-gray-300 text-gray-900 shadow-sm outline-none font-normal text-base'
            type="text"
            name="location"
